...
-- Initial migration for multi-user support

-- Enable UUID extension (Supabase has pgcrypto enabled by default which provides gen_random_uuid())
-- We'll use gen_random_uuid() instead of uuid_generate_v4() for better compatibility
